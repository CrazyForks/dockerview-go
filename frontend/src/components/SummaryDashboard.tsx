  ...
  return (
    <div className="glass-card rounded-[24px] p-6 mb-[50px] shadow-2xl flex flex-col md:flex-row gap-6 md:items-center divide-y md:divide-y-0 md:divide-x divide-white/5">
      ...
      <div className="flex-1 pb-4 md:pb-0 md:pr-6 flex items-center justify-around gap-4">
        ...
        <div className="text-left">
          <div className="text-[10px] font-bold text-text-dim uppercase tracking-[1.5px] mb-1">{t('summary.active')}</div>
      ...
      <div className="flex-[1.5] py-4 md:py-0 md:px-6 flex flex-col justify-center">
        <div className="text-[10px] font-bold text-text-dim uppercase tracking-[1.5px] mb-3 text-left">{t('summary.containerHealth')}</div>
        <div className="flex items-center gap-6 justify-between">
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-success shadow-[0_0_8px_rgba(0,255,170,0.4)]" />
            <div className="text-left">
              <div className="text-[9px] font-extrabold text-text-dim uppercase tracking-[1px]">{t('container.healthHealthy')}</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-left">
              <div className="text-[9px] font-extrabold text-text-dim uppercase tracking-[1px]">{t('container.healthWarning')}</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-left">
              <div className="text-[9px] font-extrabold text-text-dim uppercase tracking-[1px]">{t('container.healthDanger')}</div>
